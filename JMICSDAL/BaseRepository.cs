...
namespace MTC.JMICS.DAL
{
    ...
    public static class BaseRepository
    {
        ...
        private static string sqlConnectionString = AppSettings.Configuration.GetSection("ConnectionStrings")["JMICSDBConnection"]; // @"Data Source = 192.168.2.127;initial catalog=JMICSDB;user id=sa;password=786MTCserver;MultipleActiveResultSets=true";
        ...
        public static async Task<T> Get<T>(object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.Query<T>(sb.ToString(), dynParms, transaction, true, commandTimeout).FirstOrDefault();
                    connection.Close();
                    return result;
                }
            });
        ...
        public static async Task<IEnumerable<T>> GetList<T>(object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
        ...
        public static async Task<IEnumerable<T>> GetList<T>(string conditions, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.Query<T>(sb.ToString(), parameters, transaction, true, commandTimeout);
                    connection.Close();
                    return result;
                }
            });
        ...
        public static async Task<IEnumerable<T>> GetList<T>()
        {
            return await GetList<T>(new { });
        }
        ...
        public static async Task<IEnumerable<T>> GetListPaged<T>(int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.Query<T>(query, parameters, transaction, true, commandTimeout);
                    connection.Close();
                    return result;
                }
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>Gets a paged list of entities with optional exact match where conditions</returns>
        public static async Task<IEnumerable<T>> GetListPaged<T>(int pageNumber, int rowsPerPage, Dictionary<string, object> conditions, string orderby, string[] parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            if (string.IsNullOrEmpty(_getPagedListSql))
                throw new Exception("GetListPage is not supported with the current SQL Dialect");
            ...
            query = query.Replace("{RowsPerPage}", rowsPerPage.ToString());
            query = query.Replace("{OrderBy}", orderby);
            query = query.Replace("{WhereClause}", BuildWhere<T>(conditions, parameters));
            query = query.Replace("{Offset}", ((pageNumber - 1) * rowsPerPage).ToString());
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.Query<T>(query, null, transaction, true, commandTimeout);
                    connection.Close();
                    return result;
                }
            });
        ...
        public static async Task<int> Insert<TEntity>(TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return await Insert<int, TEntity>(entityToInsert, transaction, commandTimeout);
        }
        ...
        public static async Task<TKey> Insert<TKey, TEntity>(TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static async Task<int> Update<TEntity>(TEntity entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var r = connection.Execute(masterSb.ToString(), entityToUpdate, transaction, commandTimeout);
                    connection.Close();
        ...
        public static async Task<int> Delete<T>(T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var masterSb = new StringBuilder();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        public static async Task<int> Delete<T>(object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
            ...
            // Soft Delete
            sb.AppendFormat("Update {0} Set Active = 0  where ", name);
            //sb.AppendFormat("DELETE FROM {0} WHERE ", name);
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var r = connection.Execute(sb.ToString(), dynParms, transaction, commandTimeout);
                    connection.Close();
                    return r;
                }
            });
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        public static async Task<int> DeleteList<T>(object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var masterSb = new StringBuilder();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        public static async Task<int> DeleteList<T>(string conditions, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var masterSb = new StringBuilder();
        ...
        public static async Task<int> RecordCount<T>(string conditions = "", object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>Returns a count of records.</returns>
        public static async Task<int> RecordCount<T>(object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.ExecuteScalar<int>(sb.ToString(), whereConditions, transaction, commandTimeout);
                    connection.Close();
                    return result;
                }
            });
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>Returns a count of records.</returns>
        public static async Task<int> RecordCount<T>(Dictionary<string, object> conditions, string[] parameters, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            if (conditions == null)
            ...
            //conditions.Add("@Active", true);
            var query = string.Format("Select count(1) from {0} {1} ", name, BuildWhere<T>(conditions, parameters));
            ...
            var task = Task.Run(() =>
            {
                ...
                using (connection = new SqlConnection(sqlConnectionString))
                {
                    ...
                    var result = connection.ExecuteScalar<int>(query, null, transaction, commandTimeout);
                    connection.Close();
                    return result;
                }
            });
        ...
        private static string BuildWhere<TEntity>(Dictionary<string, object> conditions, string[] parameters)
        {
            ...
            for (var x = 0; x < sourceProperties.Count(); x++)
            {
                conditions.ToList<KeyValuePair<string, object>>().ForEach(q =>
                {
                    ...
                    {
                        where += string.Format(" and {0} = '{1}'", q.Key.Replace("@", ""), q.Value);
                    }
                });
            }
            if (conditions.Keys.FirstOrDefault(x => x == "@keyfilter") != null)
            {
                ...
                {
                    where = where.Replace("/filterWhere/", string.Format("OR isnull({1},'') like  case when isnull('{0}' ,'') = '' then isnull({1},'') else  '%' + '{0}' + '%' end	/filterWhere/ ", keyFilterValue, parameters[i]));
                }
        ...
        private static string BuildWhere<TEntity>(Dictionary<string, object> conditions)
        {
            string where = " WHERE 1=1  ";
