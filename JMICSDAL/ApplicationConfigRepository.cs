...
{
    public class ApplicationConfigRepository : IRepository<ApplicationConfig>, IDisposable
    {
        ...
        public int RecordCount<T>(Dictionary<string, object> conditions)
        {
            return BaseRepository.RecordCount<T>(conditions).Result;
        }
