...
{
    public class AmplifyingReportRepository : IRepository<AmplifyingReport>, IDisposable
    {
        ...
        {
            return BaseRepository.GetList<T>().Result;
        }
        public IEnumerable<T> GetList<T>(object whereConditions)
        {
            return BaseRepository.GetList<T>(whereConditions).Result;
        }
        ...
        public int Insert<T>(T entityToInsert)
        {
        ...
        public int RecordCount<T>(Dictionary<string, object> conditions, string[] parameters = null)
        {
            return BaseRepository.RecordCount<T>(conditions, parameters).Result;
        }
